...
export default function SignupForm() {
  ...
  return (
    <form action={dispatch} className="flex flex-col items-center gap-4 space-y-3">
      <div className="w-full flex-1 rounded-lg border gradient-fg px-6 pb-4 pt-8 shadow-md md:w-96">
        ...
        <div className="w-full">
          <div>
            ...
            <div className="relative">
              <input
                className="peer block w-full rounded-md border gradient-fg px-2 py-[9px] text-sm outline-none placeholder:text-zinc-500 dark:border-zinc-800"
                id="email"
                type="email"
                name="email"
...
function LoginButton() {
  ...
  return (
    <button
      className="my-4 flex h-10 w-full flex-row items-center justify-center rounded-md gradient-clr p-2 text-sm font-semibold text-zinc-900 dark:text-zinc-100"
